...
#        {
#  "custom_value_generators": "custom_value_gen.py",
#  "max_combinations": 6
#}
        ...
        # Note: all of them are expected to fail, since the grammar contains requests that are not implemented in
        ...
        try:
            with open(testing_summary_file_path, 'r') as file:
                ...
                self.assertLessEqual(total_requests_sent, 6)
# TODO: fix after bug fix                self.assertLessEqual(total_object_creations, 0)
