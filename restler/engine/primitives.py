...
class CandidateValuesPool(object):
    ...
    def get_fuzzable_values(self, primitive_type, default_value, request_id=None, quoted=False, examples=None):
        ...
        """
        candidate_values = self.get_candidate_values(primitive_type, request_id, quoted=quoted,examples=examples)
        # If the values are dynamically generated, return the generator

        if isinstance(candidate_values, types.FunctionType) and\
