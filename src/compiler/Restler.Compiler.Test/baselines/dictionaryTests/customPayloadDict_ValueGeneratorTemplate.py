...
def placeholder_value_generator():
    while True:
        ...
        yield str(random.choice([1, 0, -1, 100, 2**10, 2**20, -999999]))
        yield str(round(random.uniform(-10, 10), random.randint(0, 20)))
        yield str(random.uniform(-1, 1))
        yield "2020-11-18"
        yield "2030-11-18 00:00:59.000111"
